...
- 2、项目完全基于【百度秒哒】开发，这款Vibe Coding工具的技术生态很封闭，使用时无法查看原始代码，并且下载原始代码需要大量的Token，我们为了节约使用成本只下载了最终版本commit到Github，所以只有一个commit记录，但已经在【百度秒哒】公开了创建过程，我们能够证明这个项目是在本次黑客松期间从0到1搭建起来的。
